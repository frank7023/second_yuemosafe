package com.example.yuemosafe.activity.scanvirus.adapter;
...
/**
 * Created by yueyue on 2017/4/30.
 */
...
public class ScanVirusAdapter extends BaseAdapter {
    ...
    @Override
    public ScanAppInfo getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ScanAppInfo scanAppInfo = getItem(position);
