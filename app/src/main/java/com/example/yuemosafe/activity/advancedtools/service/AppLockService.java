package com.example.yuemosafe.activity.advancedtools.service;
...
import com.example.yuemosafe.activity.advancedtools.EnterPswActivity;
...
public class AppLockService extends Service {
    ...
    public void onCreate() {
        ...
        IntentFilter filter = new IntentFilter("com.example.yuemosafe.applock");
    ...
    class AppLockReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.example.yuemosafe.applock".equals(intent.getAction())) {
